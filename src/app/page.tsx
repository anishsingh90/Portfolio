...
import { personalData, skills, achievements, timeline, passions, socialLinks } from '@/lib/data';
...
import { ProjectRegistry__factory, ProjectRegistry } from '@/lib/contracts/types'; 
...
export default function Home() {
  ...
  const [summary, setSummary] = useState("I am a skilled blockchain developer with experience in creating decentralized applications. I am passionate about leveraging blockchain technology to build innovative solutions. This summary was generated by AI!");
  const [projects, setProjects] = useState<ProjectRegistry.ProjectStructOutput[]>([]);
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="flex gap-4 pt-4">
                <Button asChild size="lg">
                  <Link href={account ? "#projects" : "#"} onClick={(e) => !account && e.preventDefault()}>View My Work</Link>
                </Button>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {projects.map((project, index) => (
                          <Card key={index} className="flex flex-col overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:shadow-primary/30 bg-card/60 hover:-translate-y-2 border-border/30">
                            <Image src="https://placehold.co/600x400.png" alt={project.title} width={600} height={400} className="w-full h-48 object-cover" data-ai-hint="blockchain network"/>
                            <CardHeader>
             ...
             <div className="text-center py-40">
                <Card className="max-w-md mx-auto bg-card/50 shadow-lg border-border/20 p-8">
                    ...
                    <CardDescription className="text-muted-foreground mb-6">
                        Please connect your wallet to view my projects, skills, and achievements.
                    </CardDescription>
